...
// ✅ আপনার প্রোজেক্টে AppLayout যেখানেই আছে সেই path দিন
...
class _DeviceAddScreenState extends State<DeviceAddScreen> {
  ...
  String get _termsClean {
    // চাইলে &nbsp; সমস্যা হলে এটা helpful
    return _terms.replaceAll('&nbsp;', ' ').trim();
  }
  ...
  Future<void> _load({bool sendOtp = false, bool resend = false}) async {
    ...
    try {
      String endpoint = '/v1/my-device-verification/create';
  ...
  Future<void> _verify() async {
    ...
    try {
      final res = await _api.postData('/v1/my-device-verification', {
        'code': code,
        'target': 'app',
      });
